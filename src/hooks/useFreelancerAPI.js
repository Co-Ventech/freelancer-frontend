...
export const useFreelancerAPI = () => {
 ...
 const loadProjectsFromStorage = useCallback(() => {
  ...
  // }, [currentUser, getUserInfo, getUserSkills, getProjectsBySkills]);
   ...
   /**
   * Automatically place bids on recent projects.
   */
...
//     return project.submitdate && nowUnix - project.submitdate <= 60; // Projects less than 1 minute old
//   });
...
//   try {
//     // Fetch the bidder_id (userId of the current user)
...
//             bidder_id: bidderId,
//             amount: project.budget?.minimum || 250,
//             period: 5,
